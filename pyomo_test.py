...
from pyomo_utils import solve_gams_direct, solve_executable
...
if True:
    ...
    env = pyomo.environ.RangeSet(0,1)
...
print("EXECUTABLE DIRECT")
sol = solve_executable(model,solver="COUENNE")
